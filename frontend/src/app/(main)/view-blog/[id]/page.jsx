...
const ViewBlog = () => {
  ...
  const displayBlogs = () => {
    if (blogData !== null)
      return (
        <div>
          <h1 className='text-center text-blue-900  text-6xl font-bold mb-10'>{blogData.title}</h1>
          ...
          >
            ...
            <div className="col-span-9 overflow-auto">
              <MDEditor.Markdown source={blogData.content} style={{ background: 'none' }} className='overflow-auto' />
            </div>
          </div>
        </div>
      )
